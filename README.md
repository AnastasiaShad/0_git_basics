...
10. Через текстовый редактор добавить любую новую строку с комментарием
11. Сделать коммит
12. Вности синтаксическую ошибку в скрипт
13. Сделать коммит ошибочного скрипта
14. Откатываем до последней рабочей версии
15. Просмотреть историю коммитов
16. Добавить несколько коммитов произвольного содержимого
17. Создать пулл реквест в данный репозиторий
